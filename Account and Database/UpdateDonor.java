...
public class UpdateDonor {
    ...
    UpdateDonor() {
        ...
        updateDoner_btn = new JButton("Update Donor Record");
        updateDoner_btn.setBounds(100, 410, 170, 30);
        updateDoner_btn.setFocusPainted(false);
